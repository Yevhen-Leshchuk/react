...
## Практика приложения на React

- [Building a GIF search engine](https://tighten.co/blog/react-101-building-a-gif-search-engine/)
...
- [Практика по Next.js](https://medium.appbase.io/part1-getting-started-with-react-and-nextjs-4f28a6a0c38e)
...
- [TS в create-react-app](https://create-react-app.dev/docs/adding-typescript/)
- [Руководство](https://www.typescriptlang.org/docs/handbook/intro.html)
